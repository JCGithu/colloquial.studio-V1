...
const settings = {
  ...
  description: `Please input the channel of the Twitch chat you want to pull the emotes from.<br><br> After picking your settings you can find the URL to put into OBS at the bottom!</p>`,
}
